...
for (i in 1:3){
        ...
        SC[[i]]<-df
        names(SC)[i]<-filename
        write.csv(df,paste0("Output/SelCoeff/SC_",filename,"_summary.csv"))
...
for (i in 1:length(SC)){
     ...
     for (typeofsite in c("syn", "nonsyn","stop")){
        ...
        write.csv(wilcoxtest1,paste0("Output/SelCoeff/WilcoxonResults_by_Type_",fname,".csv"))
        ...
        write.csv(Type.sc,paste0("Output/SelCoeff/SelCoeff_byType_Summary_",fname,".csv"))
        ...
        write.csv(SCbyType2,paste0("Output/SelCoeff/SelCoef_byNt_",fname,".csv"))
        ...
        write.csv(WilcoxTest.nt.sc,paste0("Output/SelCoeff/WilcoxTestResults_byNT_",fname,".csv"))
        write.csv(nuc.sc,paste0("Output/SelCoeff/SelCoef_byNT_",".csv"))
}
