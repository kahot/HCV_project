...
#unfiltered Mut. freq (including the sites Ref != Maj)
mf.unfiltered<-read.csv("Output_all/Unfiltered/Ts_Mean_3genotypes.csv", stringsAsFactors = F)
...
for (g in 1:3){
        ...
        mutf<-mf.unfiltered[,c("merged.pos",paste0("mean.",g1),paste0("mean.",g2))]
        #mutf<-mutf[260:8600,]
